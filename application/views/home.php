...
<html lang="en">
  ...
  <body>
        ...
        <div class="row">
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<a href="#" class="img" style="background-image: url(<?php echo base_url('assets/images/work-1.jpg')?>);"></a>
        			<div class="text">
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<a href="#" class="img" style="background-image: url(<?php echo base_url('assets/images/work-2.jpg')?>);"></a>
        			<div class="text">
        				<p class="price"><span class="old-price">800,000</span><span class="orig-price">$3,050<small>/mo</small></span></p>
        				<ul class="property_list">
        					<li><span class="flaticon-bed"></span>3</li>
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<a href="#" class="img" style="background-image: url(<?php echo base_url('assets/images/work-3.jpg')?>);"></a>
        			<div class="text">
        				<p class="price"><span class="old-price">800,000</span><span class="orig-price">$3,050<small>/mo</small></span></p>
        				<ul class="property_list">
        					<li><span class="flaticon-bed"></span>3</li>
    ...
    <section class="ftco-section ftco-degree-bg services-section img mx-md-5" style="background-image: url(<?php echo base_url('assets/images/bg_2.jpg')?>);">
    	<div class="overlay"></div>
    	<div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.html" class="block-20 img" style="background-image: url(<?php echo base_url('assets/images/image_1.jpg')?>);">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.html" class="block-20 img" style="background-image: url(<?php echo base_url('assets/images/image_2.jpg')?>);">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.html" class="block-20 img" style="background-image: url(<?php echo base_url('assets/images/image_3.jpg')?>);">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <a href="blog-single.html" class="block-20 img" style="background-image: url(<?php echo base_url('assets/images/image_4.jpg')?>);">
	              </a>
                <p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
              </div>
            </div>
